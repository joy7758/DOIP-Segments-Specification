...
- Repository / 仓库名: `DOIP-Segments-Specification`

### EN Summary / 英文摘要
Segment schemas and interoperability assets for Digital Object Interface Protocol.

### CN Summary / 中文摘要
数字对象接口协议（DOIP）的分段模式与互操作资产。

### SEO Keywords / 检索关键词
`doip`, `pid`, `interoperability`, `schema`, `fair-digital-object`

### Suggested Search Phrases (EN)
- DOIP-Segments-Specification RR-DOIP open standard
- DOIP-Segments-Specification doip pid github
- RR-DOIP doip reference implementation

### 建议检索短语（中文）
- DOIP-Segments-Specification RR-DOIP 标准 规范
- DOIP-Segments-Specification doip pid 仓库
- RR-DOIP 参考实现 红岩 宪章

### Quick Links / 快速入口
- Governance Hub / 总入口: https://github.com/joy7758/RedRock-Constitution
- Standards Registry / 标准注册表: https://github.com/joy7758/RedRock-Constitution/blob/main/docs/registry/STANDARDS_REGISTRY.md#rr-doip
...
- Onepager / 一页纸: https://github.com/joy7758/DOIP-Segments-Specification/blob/main/docs/onepager/RR-DOIP_ONEPAGER_CN_EN.md
...
- Onepager / 一页纸：`docs/onepager/RR-DOIP_ONEPAGER_CN_EN.md`
